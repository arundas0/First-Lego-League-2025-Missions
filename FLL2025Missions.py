...
def mission_0():
    ...
    drive_cm(55, 100, 50)
    gyro_turn(-65, slow_turn=False)

    drive_cm(16.5, 30, 30)

    run_motor_for_degrees(motor_d, -1000, 1000)  # SPIKE: move_sidearm_mission9(port.D, -1000, 1000, 500)
    run_motor_for_degrees(motor_c, 100, 1000)    # SPIKE: move_sidearm_mission9(port.C, 100, 1000, 500)
...
# START = LEFT + RIGHT together (avoids CENTER/SystemExit)
# -----------------------------
